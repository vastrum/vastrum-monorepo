            ...
            <div className="p-6 space-y-6">
                <div>
                    ...
                    <ul className="list-disc list-inside text-app-text-secondary ml-2 space-y-1">
                        <li>Push, clone using vastrum-cli</li>
                ...
                <div className="flex flex-col gap-1 text-sm">
                    <a href="https://docs.vastrum.net/apps/gitter" target="_blank" rel="noopener noreferrer" className="text-app-accent hover:underline">
                        Gitter docs
                    </a>
