...
function Modal({ isOpen, onClose, title, children }: ModalProps): React.JSX.Element | null {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <div className="bg-app-bg-secondary border-2 border-app-border rounded-lg max-w-full md:max-w-2xl lg:max-w-4xl w-full max-h-[90vh] overflow-hidden relative shadow-[0_20px_60px_rgba(0,0,0,0.12)]">
                {/* Modal Header */}
