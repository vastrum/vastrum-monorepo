...
<!-- blocker -->[d66m4cniuqbgkeuetyvcbkfqfutt3qd3hdxdby2tlqifbt3otctq.vastrum.net](https://d66m4cniuqbgkeuetyvcbkfqfutt3qd3hdxdby2tlqifbt3otctq.vastrum.net)
...
The blockchain indexer on vastrum-node lives in <!-- gitter -->[vastrum-node/src/block_indexer/indexer.rs (gitter preview)](https://yts27rvo7ppzq5rrjyavmfwecrbyc5ksldmitiggycetgh6zguoa.vastrum.net/repo/vastrum/tree/vastrum-node/src/block_indexer/indexer.rs). Everytime a block is executed the indexer is called which writes metadata for every transaction executed in the block.
...
<!-- gitter -->[Blocker on Gitter](https://yts27rvo7ppzq5rrjyavmfwecrbyc5ksldmitiggycetgh6zguoa.vastrum.net/repo/vastrum/tree/apps/blocker)