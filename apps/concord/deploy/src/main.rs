...
async fn main() {
    ...
    register_domain(client.site_id(), "concord").await.await_confirmation().await;
    ...
    let static_site_id =
        Sha256Digest::from_string("x647757zpbejyzxcw7ruqcju32otdmi7vphrg36vhhzglkjccaqq").unwrap();
