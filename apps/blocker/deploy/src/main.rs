...
async fn main() {
    ...
    register_domain(client.site_id(), "blocker").await.await_confirmation().await;
    ...
    let static_site_id =
        Sha256Digest::from_string("d66m4cniuqbgkeuetyvcbkfqfutt3qd3hdxdby2tlqifbt3otctq").unwrap();
