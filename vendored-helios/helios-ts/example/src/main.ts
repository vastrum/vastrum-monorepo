  ...
  const networks: NetworkConfig[] = [
    {
      ...
      cfg: {
        ...
        executionRpc: `http://localhost:3000/ethexecutionrpc`,
        //consensusRpc: "http://localhost:8080/?url=http://testing.mainnet.beacon-api.nimbus.team",
        consensusRpc: "http://localhost:3000/ethconsensusrpc",

        checkpoint:
          "0xba5869170c12f08d453e6ec9507ace9feba8c0358068e1198349b3118f9d63bb",
        dbType: "config",
      },
      kind: "ethereum",
      chain: mainnet,
